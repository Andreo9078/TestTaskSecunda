...
class OrganizationService:
    def __init__(
        self,
        org_repo: BaseOrganizationRepository
    ):
    ...
    async def get_all_in_radius(
        ...
        orgs = self._org_repo.get_all_in_radius(
            center,
            radius,
            **filters
        )
    ...
    async def get_all_in_bbox(
        self,
        sw_latitude: float, sw_longitude: float,
        ...
        **filters
        ...
        orgs = self._org_repo.get_all_in_bbox(
            sw, ne,
            **filters
        )
    ...
    async def get_all_in_actively_tree(
        self, actively_root_id: UUID, **filters
    ):
        orgs = self._org_repo.get_all_by_activity_tree(
            actively_root_id,
            **filters
        )
