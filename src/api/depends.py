...
from src.infrastructure.repos.sqlalchemy_repos.mappers import OrganizationORMMapper, \
    ActivityORMMapper, PhoneORMMapper, BuildingORMMapper
...
def get_org_service(
    org_repo: Annotated[OrganizationRepo, Depends(_get_org_repo)]
):
    return OrganizationService(org_repo=org_repo)


OrganizationServiceDepends: TypeAlias = Annotated[OrganizationService, Depends(get_org_service)]
